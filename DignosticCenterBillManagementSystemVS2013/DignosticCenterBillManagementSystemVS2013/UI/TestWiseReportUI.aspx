<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestWiseReportUI.aspx.cs" Inherits="DignosticCenterBillManagementSystemVS2013.UI.TestWiseReportUI" %>
    ...
    <div>
        ...
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    <asp:GridView ID="showGridView" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" style="margin-left: 0px" Width="467px">
                        <Columns>
        ...
        <table class="auto-style1">
            <tr>
                ...
                <td class="auto-style25">
                    <asp:Button ID="homeButton" runat="server" Font-Size="Medium" OnClick="homeButton_Click" style="text-align: right" Text="Home" />
                </td>
